...
namespace STC.API.Migrations
{
    ...
    [Migration("20190814031139_UserReimbursementSetSomePropertyNull")]
    partial class UserReimbursementSetSomePropertyNull
    {
            ...
            modelBuilder.Entity("STC.API.Entities.CashReimbursementEntity.UserReimbursement", b =>
                {
                    ...
                    b.HasIndex("ProcessById")
                        .IsUnique()
                        .HasFilter("[ProcessById] IS NOT NULL");
            ...
            modelBuilder.Entity("STC.API.Entities.CashReimbursementEntity.UserReimbursement", b =>
                {
                    b.HasOne("STC.API.Entities.UserEntity.User", "CreatedBy")
                        .WithOne()
                        .HasForeignKey("STC.API.Entities.CashReimbursementEntity.UserReimbursement", "CreatedById")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("STC.API.Entities.UserEntity.User", "ProcessBy")
                        .WithOne()
                        .HasForeignKey("STC.API.Entities.CashReimbursementEntity.UserReimbursement", "ProcessById")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("STC.API.Entities.UserEntity.User", "User")
                        .WithOne()
                        .HasForeignKey("STC.API.Entities.CashReimbursementEntity.UserReimbursement", "UserId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
