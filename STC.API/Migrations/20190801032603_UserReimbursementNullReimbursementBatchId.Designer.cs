...
namespace STC.API.Migrations
{
    ...
    [Migration("20190801032603_UserReimbursementNullReimbursementBatchId")]
    partial class UserReimbursementNullReimbursementBatchId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("STC.API.Entities.CashReimbursementEntity.ReimbursementBatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("STC.API.Entities.CashReimbursementEntity.UserReimbursement", b =>
                {
                    ...
                    b.Property<int?>("ReimbursementBatchId");

                    b.Property<DateTime>("ReimbursementPeriodEnd");

                    b.Property<DateTime>("ReimbursementPeriodStart");
                    ...
                    b.HasIndex("ReimbursementBatchId");
            ...
            modelBuilder.Entity("STC.API.Entities.CashReimbursementEntity.UserReimbursement", b =>
                {
                    b.HasOne("STC.API.Entities.CashReimbursementEntity.ReimbursementBatch", "ReimbursementBatch")
                        .WithMany("UserReimbursement")
                        .HasForeignKey("ReimbursementBatchId")
                        .OnDelete(DeleteBehavior.Restrict);
